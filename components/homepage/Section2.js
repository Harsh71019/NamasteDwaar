      ...
      <div className='container px-0 d-flex justify-content-center'>
        <div className='section-2'>
          <p className='section-2-para text-para'>
            ...
            Divine relaxation is infectious at Namaste Dwaar, and there’s no
            better way to experience it than with one of the resort’s many
            treatments. Wind down and drift away with customized Ayurveda, Spa
            and other Wellness treatments customized as per your need.
          </p>
        </div>
      </div>
